...
namespace Menus
{
    public class LighthousesMenu : IMenu
    {
        public LighthousesMenu(LighthouseData questData) { Data = questData; }
        ...
        public class MenuScene : IMenuScene
        {
            ...
            public void Initialize()
            {
                ...
                East.SetTextString("Teleport").SetImageColor(Color.clear).SetTextColor(Color.clear);
