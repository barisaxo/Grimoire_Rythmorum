...
//         MainMenu = (MainMenu)new MainMenu().Initialize(SaveDataExists ? MainMenu.MainMenuItem.Continue : MainMenu.MainMenuItem.NewGame);
...
//         MainMenu.Selection = MainMenu.Layout.ScrollMenuItems(dir, MainMenu.Selection, MainMenu.MenuItems);
//         MainMenu.UpdateTextColors();
