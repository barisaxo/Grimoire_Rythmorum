...
//         GamePlayMenu.Selection = GamePlayMenu.Selection = GamePlayMenu.Layout.ScrollMenuItems(dir, GamePlayMenu.Selection, GamePlayMenu.MenuItems);
//         GamePlayMenu.UpdateTextColors();
//         ToggleTuningNote();
//     }
...
//     {
//         Options.Selection = Options.Layout.ScrollMenuItems(Dir.Left, Options.Selection, Options.MenuItems);
//         Options.UpdateTextColors();
//         UpdateMenu();
//     }

//     protected override void R1Pressed()
//     {
//         Options.Selection = Options.Layout.ScrollMenuItems(Dir.Right, Options.Selection, Options.MenuItems);
//         Options.UpdateTextColors();
//         UpdateMenu();
//     }
