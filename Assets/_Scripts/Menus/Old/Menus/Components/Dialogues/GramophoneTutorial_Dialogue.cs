...
public class GramophoneTutorial_Dialogue : Dialogue
{
    ...
    private static string[] _Musica => new[]
    {
        ...
        "Don't just guess at answers! Listen to the whole cadence a few times and only answer when you are sure you are ready.",
    ...
    private Line GetStartLine()
    {
        ...
        var lines = new Line[Musica.Length];
        for (var i = 0; i < lines.Length; i++) lines[i] = new Line(Musica[i]);
...
{
    public MuscopaTutorial_Dialogue(Dialogue returnTo) { ReturnToDialogue = returnTo; }
    readonly Dialogue ReturnToDialogue;


    public MuscopaTutorial_Dialogue(State returnTo) { ReturnToState = returnTo; }
    readonly State ReturnToState;
    ...
    {
        "Muscopa is a musical card game that challenge your aural capacities.",
        "You must use your ear and solve diatonic chordal cadences (or chord progressions).",
        "Please note, you do not need to play Muscopa to beat this game, but it can help you progress faster and find more rewards.",
        "You can challenge trade ships to a game of Muscopa while at sea.",
        "The first chord will always be related to the mode of the ships region.",

        "While playing Muscopa you'll hear a four-chord cadence, and your objective is to identify the harmonic functions of these chords.",
        "There are three types of harmonic functions: tonic, subdominant, and dominant. However, there are seven chords in all.",
