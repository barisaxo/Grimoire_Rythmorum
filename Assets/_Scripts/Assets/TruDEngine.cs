// /* 
//     This simple project is an adaptation from OneLoneCoder's YouTube video,
...
//     I have transposed it to C#, and I'm using the Unity engine.
//     The philosophy of the project remains true to OLC's 3D engine. 
...
//     public class Trwo_Dee
//     {
//         // [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.AfterSceneLoad)]
//         private static void Init()
//         {
//             Camera cam = new GameObject(nameof(Camera)).AddComponent<Camera>();
//             cam.orthographic = true;
//             cam.orthographicSize = 44;
//             cam.farClipPlane = 100;
//             cam.backgroundColor = Color.grey;
//             cam.transform.position = new Vector3(TrwoDeeEngine.nScreenWidth * .5f, TrwoDeeEngine.nScreenHeight * .5f, -10);
//             cam.transform.Rotate(new Vector3(0, 0, 180));

//             TrwoDeeEngine.SetUpMap();

//             MonoHelper monoHelper = new GameObject(nameof(MonoHelper)).AddComponent<MonoHelper>();
//             monoHelper.ToUpdate += Update;
...
//         class MonoHelper : MonoBehaviour
//         {
//             private void Update() => ToUpdate?.Invoke();
//             public event Action ToUpdate;
//         }
...
//         /* Give the player some variables to control movement etc. */
...
//         /* The sprite to be used as screen pixels. */
...
//             /* A programmer friendly visual representation of the map.
//                May be easily edited, but if the X or Y change bounds, 
...
//             for (int x = 0; x < nScreenWidth; x++)
//             {
//                 /* For each pixel column(the x coordinate),
...
//                 /* Start distance at 0, and incrementally check to find the walls distance. */
//                 float fDistToWall = 0;
//                 bool bHitWall = false;
...
//                     /* Set new distance to players facing direction. */
...
//                 /* Calculate distances to ceiling and to floor. */
