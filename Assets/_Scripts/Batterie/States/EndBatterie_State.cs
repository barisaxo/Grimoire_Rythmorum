    ...
    protected override void EngageState()
    {
        ...
        switch (Pack.ResultType)
        {
            case BatterieResultType.NMESurrender:
                ...
                SetStateDirectly(new DialogStart_State(new EndBatterie_Dialogue(coins, mats, rations, damage, false, BatterieResultType.NMESurrender)));
                return;
            ...
            case BatterieResultType.Surrender:
                ...
                SetStateDirectly(new DialogStart_State(new EndBatterie_Dialogue(coins, mats, rations, damage, false, BatterieResultType.Surrender)));
                return;

            case BatterieResultType.Spam:
                SetStateDirectly(new DialogStart_State(new EndBatterie_Dialogue(0, 0, 0, damage, false, BatterieResultType.Spam)));
                return;

            case BatterieResultType.Fled:
                // SetStateDirectly(new BoardInput_State());
                return;

            case BatterieResultType.NMEscaped:
                SetStateDirectly(new DialogStart_State(new EndBatterie_Dialogue(0, 0, 0, damage, false, BatterieResultType.NMEscaped)));

                return;

            case BatterieResultType.Lost:
                // SetStateDirectly(new DialogStart_State(new GameOver_Dialogue(false)));
                return;
            ...
            case BatterieResultType.Won:
                ...
                SetStateDirectly(new DialogStart_State(new EndBatterie_Dialogue(coins, mats, rations, damage, map, BatterieResultType.Won)));
                return;
        }
