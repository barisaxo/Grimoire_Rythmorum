...
namespace Data
{
    ...
    [Serializable] public struct Calibrate : IGameplayOption { public readonly GameplayEnum Enum => GameplayEnum.Calibrate; }
    ...
    public class GameplayEnum : Enumeration
    {
        ...
        public static readonly GameplayEnum Latency = new(0, "LATENCY",
            "Lag offset for rhythm input.\nThe margin for an accurate hit is +- 15." +
            "\nIf you are missing beats try adjusting this latency.\nDefault setting is 5.");

        public static readonly GameplayEnum Calibrate = new(1, "CALIBRATE",
            "Enter calibration mode.");

        public static readonly GameplayEnum Transpose = new(2, "KEY TRANSPOSITION",
        ...
        public static GameplayEnum Tuning = new(3, "TUNING NOTE A 440",
        ...
        public static IItem ToItem(GameplayEnum @enum) => @enum switch
        {
            ...
            _ when @enum == Calibrate => new Calibrate(),
