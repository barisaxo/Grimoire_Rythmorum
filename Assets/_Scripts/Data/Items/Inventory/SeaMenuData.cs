...
namespace Data.Two
{
    ...
    public class SeaMenuEnum : Enumeration
    {
        ...
        public static readonly SeaMenuEnum LighthouseInventory = new(4, "LIGHTHOUSES");
        public static readonly SeaMenuEnum ShipStat = new(5, "SHIP");
        public static readonly SeaMenuEnum PlayerStats = new(6, "PLAYER");
