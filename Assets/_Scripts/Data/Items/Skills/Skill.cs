...
namespace Datum
{
    ...
    public class SkillEnum : Enumeration
    {
        ...
        public SkillEnum(int id, string name, string description, float per, int cost, int max) : base(id, name)
        {
        ...
        public static SkillEnum Apophenia = new(0, "Apophenia", "Find more patterns, even if they aren't really there.", .5f, 15, 200);
