...
//     Line GetStartLine()
//     {
//         string[] muscopa = _muscopa;

//         Line[] lines = new Line[muscopa.Length];
//         for (int i = 0; i < lines.Length; i++)
//         {
//             lines[i] = new(muscopa[i]);
//         }
...
//         "The fourth scale degree 'IV' is called Fa. It is the root of our subdominant chord, known as the IV chord.",
...
//         "The second scale degree 'II' is called Re. It is the root of another subdominant chord called the lateral-subdominant, known as the II- chord. Lateral meaning adjacent to the root",
