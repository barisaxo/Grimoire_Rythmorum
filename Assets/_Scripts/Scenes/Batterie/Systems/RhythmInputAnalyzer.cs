...
namespace Rhythm
{
    public class RhythmInputAnalyzer
    {
        public RhythmInputAnalyzer(Action<string> feedBack, Action<Hit> hit, MappedBeat[] beatmap)
        {
            FeedBack += feedBack;
        ...
        public List<Window> attackWindows;
        ...
        public void RhythmInputAnalyzerTick()
        {
            UpdateClock();
            CheckAttackWindows();
            CheckHoldWindows();
